...
```
 ...
 The above chart shows that K value versus RMSE.  The RMSE mean value bottoms out at k=15.  Using the "1SE" (one standard error) rule, taking the k-value where the mean RMSE is about one standard error above the minimum, yields an optimal k-value of 125.
...
The above chart shows that K value versus RMSE.  The RMSE mean value bottoms out at k=15.  Using the "1SE" (one standard error) rule, taking the k-value where the mean RMSE is about one standard error above the minimum, yields an optimal k-value of 60.
